...
title Build ORYN Windows Setup V10.4.1 PD1
cd /d "%~dp0"

echo ============================================================
echo   ORYN V10.4.1 PD1 - Windows Installer Builder
echo   Pattern Designer V2.0 Pro - 77 generators
echo   Designed to Move - by Studio Kinematics
echo ============================================================
echo.
echo This packages the locked ORYN Windows application plus the
 echo isolated Pattern Designer module. Customer PCs do NOT need
 echo Python, Node.js, Git, or VS Code.
echo.
...
echo [4/6] Packaging ORYN standalone desktop application...
...
"%ISCC%" packaging\windows_v10_4_1\ORYN-V10.4.1-PD1.iss
if errorlevel 1 goto :fail
if not exist "release\ORYN-Windows-Setup-V10.4.1-PD1.exe" (
    echo [ERROR] Installer was not created.
    goto :fail
)

echo [6/6] Creating SHA-256 checksum...
certutil -hashfile "release\ORYN-Windows-Setup-V10.4.1-PD1.exe" SHA256 > "release\ORYN-Windows-Setup-V10.4.1-PD1.exe.sha256.txt"

echo.
echo ============================================================
echo   BUILD COMPLETE
echo   release\ORYN-Windows-Setup-V10.4.1-PD1.exe
echo ============================================================
echo.
echo Test on a clean Windows 10/11 x64 PC before publishing.
...
echo.
echo ============================================================
echo   BUILD FAILED - ORYN application source was not reverted.
echo ============================================================
pause
exit /b 1
