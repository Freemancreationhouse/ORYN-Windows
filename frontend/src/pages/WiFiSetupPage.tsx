      ...
      <Card>
        <CardContent className="pt-4 pb-3 px-4">
          ...
          <p className="text-xs text-muted-foreground mb-3">
            Set a password for the ORYN hotspot. Leave empty for an open network.
          </p>
      ...
      {isHotspotMode && (
        <>
          ...
          <div className="text-center text-sm text-muted-foreground space-y-1">
            <p>After connecting, access ORYN at:</p>
            <code className="text-xs bg-muted px-2 py-1 rounded">
              http://{status?.hostname || 'orynmotion'}.local
            </code>
          </div>
        </>
      )}
        ...
        <CardContent className="pt-4 pb-3 px-4">
          ...
          <div className="flex gap-2">
            <Button
              ...
              onClick={async () => {
                if (!confirm('Restart ORYN?')) return
                try {
            ...
            <DialogDescription>
              {willStartHotspot ? (
                <>
                  ...
                  {' '}<strong>ORYN</strong> hotspot. Connect to the ORYN WiFi to access this page again.
                </>
              ) : isForgetActive ? (
                <>
