...
class TestGetAllSettings:
    ...
    async def test_get_all_settings_returns_expected_structure(self, async_client, mock_state):
        ...
        mock_state.mqtt_client_id = "kinetiq_motion"
        mock_state.mqtt_discovery_prefix = "homeassistant"
        mock_state.mqtt_device_id = "kinetiq_motion_01"
        mock_state.mqtt_device_name = "KinetiQ Motion"
        mock_state.table_type = "kinetiq_motion"
        ...
        assert data["machine"]["detected_table_type"] == "kinetiq_motion"
    ...
    async def test_get_all_settings_effective_table_type(self, async_client, mock_state):
        ...
        mock_state.mqtt_device_name = "KinetiQ Motion"
        mock_state.table_type = "kinetiq_motion"
        mock_state.table_type_override = "kinetiq_motion_mini"  # Override set
        ...
        assert data["machine"]["detected_table_type"] == "kinetiq_motion"
        assert data["machine"]["table_type_override"] == "kinetiq_motion_mini"
        assert data["machine"]["effective_table_type"] == "kinetiq_motion_mini"
