...
logger = logging.getLogger("KinetiQMotion")

QML_IMPORT_NAME = "KinetiQMotion"
...
class Backend(QObject):
    ...
    def __init__(self):
        ...
        self.base_url = os.environ.get("KINETIQ_MOTION_URL", "http://localhost:8080")
    ...
    def restartBackend(self):
        """Restart the kinetiq-motion backend via API"""
