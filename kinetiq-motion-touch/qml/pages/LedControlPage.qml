                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        ColumnLayout {
                            ...
                            Label {
                                text: "Configure LED settings in the main KinetiQ Motion web interface"
                                font.pixelSize: 12
                                color: Components.ThemeManager.textSecondary
                        ...
                        // KinetiQ LEDs Controls - Power and Brightness in same section
                        ColumnLayout {
                        ...
                        ColumnLayout {
                            ...
                            Label {
                                text: "Use the main KinetiQ Motion web interface for WLED controls"
                                font.pixelSize: 12
                                color: Components.ThemeManager.textSecondary
                                wrapMode: Text.WordWrap
                                Layout.fillWidth: true
