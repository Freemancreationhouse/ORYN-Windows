#!/bin/bash
# Quick auto-login setup for ORYN Touch
...
echo "🔑 ORYN Touch - Auto-Login Setup"
echo "======================================="
...
if command -v raspi-config >/dev/null 2>&1; then
    ...
    if [ $? -eq 0 ]; then
        ...
        echo "   - User: $ACTUAL_USER"
        echo "   - The ORYN service will start automatically"
        echo ""
...
echo ""
echo "ℹ️  The ORYN Touch service is already configured to start automatically."
