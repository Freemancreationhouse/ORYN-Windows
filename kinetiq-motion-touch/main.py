...
async def startup_tasks():
    ...
    logger.info("🚀 Starting kinetiq-motion-touch async initialization...")
    ...
    logger.info("✨ kinetiq-motion-touch startup tasks completed")
...
def main():
    ...
    # Register types
    qmlRegisterType(Backend, "KinetiQMotion", 1, 0, "Backend")
    qmlRegisterType(PatternModel, "KinetiQMotion", 1, 0, "PatternModel")
    qmlRegisterType(PlaylistModel, "KinetiQMotion", 1, 0, "PlaylistModel")
